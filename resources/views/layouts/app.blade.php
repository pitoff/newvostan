...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="">Find Home</a>
            ...
            @if(auth()->user()->is_admin)
              <ul class="navbar-nav ml-auto">
                ...
                <form action="{{route('logout')}}" method="post">
                  @csrf
                  <li class="nav-item"><a class="nav-link"><button type="submit" class="button btn btn-primary">Logout</button></a></li>
                </form>
              </ul>
            @else
              <ul class="navbar-nav ml-auto">
          ...
          @guest
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item {{Request::is('agent') ? 'active' : ''}}"><a href="{{route('agents')}}" class="nav-link">Agent</a></li>
	          <li class="nav-item"><a href="{{route('listing')}}" class="nav-link">Listing</a></li>
